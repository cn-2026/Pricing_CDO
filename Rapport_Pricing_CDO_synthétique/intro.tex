...
Néanmoins, la loi marginale de $r_t$ est connue explicitement. On sait que $r_t$ suit une loi du $\chi^2$ non centrée après renormalisation.
...
Leurs paramètres constants les empêchent de calibrer exactement une courbe de taux observée, limitation que corrigent des modèles comme Hull--White ou G2++, au prix d'une implémentation plus lourde.
Ils restent néanmoins de premiers modèles simples pour comprendre la simulation de taux court et les méthodes numériques associées.
